 ...
 * @author Zeh Fiorillo
 */
public class Cliente implements java.io.Serializable, Comparable{
    private int codigo;
    private String nome;
    private String rg;
    private int tipdoc;
    ...
    public Cliente(int codigo, String nome, String rg, int tipdoc, String docum, String endere, String numero, String bairro, String cep, String cidade, String uf){
        setCodigo(codigo);
        setNome(nome); 
        setRg(rg);
        setTipdoc(tipdoc);
