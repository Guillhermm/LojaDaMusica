 ...
 */
public class InclusaoDeCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BG_Doc = new javax.swing.ButtonGroup();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(L_Codigo, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(L_Nome)
                    .addComponent(L_RG)
        ...
        L_Codigo.getAccessibleContext().setAccessibleName("Código");
    ...
    private void B_GravarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_B_GravarMouseClicked
        ...
        Cliente vCliente = new Cliente(Integer.valueOf(TF_Codigo.getText()), 
                                                       TF_Nome.getText(), 
                                                       TF_RG.getText(),
                                                       tipdoc,                                                       
        ...
        String texto;
        if(tipo=="I"){
            vArquivo.salvaLista(tipo, 0, vCliente);
            texto = "Cadastrado";
        }
        else{
            vArquivo.salvaLista(tipo, index, vCliente);
            texto = "Alterado";
        }
        try {
            vArquivo.gravarLista();
        } catch (IOException ex) {
            Logger.getLogger(InclusaoDeCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        ProcDadosCli vProcDadosCli = new ProcDadosCli();
        vProcDadosCli.getLista(grid, vArquivo, 0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InclusaoDeCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InclusaoDeCliente().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.ButtonGroup BG_Doc;
